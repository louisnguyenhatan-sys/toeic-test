...
export default function TeacherPage() {
  ...
  async function extractQuestions() {
    ...
    try {
      ...
      const res = await fetch("/api/extract-test", { method:"POST", headers:{"Content-Type":"application/json"}, body:JSON.stringify({images, answerKey}) });
      const data = await res.json(); if (!res.ok) throw new Error(data.error || "Could not read images.");
